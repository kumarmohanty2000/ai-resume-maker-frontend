...
export default function DashboardPage() {
  ...
  const features = [
    ...
    { title: 'Resume Checker', description: 'Get instant feedback and suggestions to improve your resume.', href: '/commingsoon', icon: CheckSquare },
    { title: 'Cover Letter Generator', description: 'Create compelling cover letters for your job applications.', href: '/commingsoon', icon: PenTool },
    { title: 'Interview Preparation', description: 'Practice with tailored interview questions for your target role.', href: '/commingsoon', icon: Users },
  ]
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 to-indigo-800">
      ...
      <nav className="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg p-4 sticky top-0 z-10">
        <div className="container mx-auto flex justify-between items-center">
          <h1 className="text-2xl font-bold text-white">ResumeBoost</h1>
          <Button
            variant="ghost"
